...
for ($x=0; $x<@ARGV; $x++){
	...
	system("kraken2 --db ~/DB/kraken2/DB --threads 20 --report $kraken2report --paired $file1 $file2");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_D -w $bracken_w_D -r 150 -l D");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_P -w $bracken_w_P -r 150 -l P");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_C -w $bracken_w_C -r 150 -l C");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_O -w $bracken_w_O -r 150 -l O");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_F -w $bracken_w_F -r 150 -l F");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_G -w $bracken_w_G -r 150 -l G");
	system("bracken -d ~/DB/kraken2/DB -i $kraken2report -o $bracken_o_S -w $bracken_w_S -r 150 -l S");
	}
