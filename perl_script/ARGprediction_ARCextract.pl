...
for ($x=0; $x<@ARGV; $x++){
	...
	system("diamond blastx -d /media/sf_sf/DB/Diamond/DB/SARG2.2_DB.dmnd -q $orf -p 16 --id 70 -p 16 -e 1e-10 -f 6 -k 1 --query-cover 50 -o $diamondout");
	...
	system("diamond blastx -d /media/sf_sf/DB/Diamond/DB/SARG2.2_DB.dmnd -q $prodigalout_nucl -p 16 --id 70 -p 16 -e 1e-10 -f 6 -k 1 --query-cover 50 -o $ARCorfrediamondout");
