...
while (1) {
    ...
    print "SARG_adjust_DB_xlsx=/home/tungs-lab/ARG_OAPv3/SARG_database_v3.2.1/SARG_Full_database_V3.2.1/1.SARG_v3.2_20220917_Full_structure.xlsx\n";
...
$SARG_adjust_DB_xlsx="/home/tungs-lab/ARG_OAPv3/SARG_database_v3.2.1/SARG_Full_database_V3.2.1/1.SARG_v3.2_20220917_Full_structure.xlsx";
...
Diamond_SARG_hit<-read.table(file="$dmndfile",header=F)
colnames(Diamond_SARG_hit)<-c("orf_qseqid", "gene", "pident", "length", "mismatch", "gapopen", "qstart", "qend", "sstart", "send", "evalue", "bitscore")
Diamond_SARG_hit_annoate<-merge(Diamond_SARG_hit,SARG_adjust_list,all.x = T,by="gene")
#bbmapadjust檔案讀取
